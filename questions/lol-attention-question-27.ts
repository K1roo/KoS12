...
@Injectable()
export class LolAttentionQuestion27 extends LolAttentionQuestion {
  private _logger: WinstonLogger = new WinstonLogger(
    LolAttentionQuestion27.name,
  );
  public readonly id = 27;
  public readonly title = 'Did {{streamerName}} last hit inhibitors?';
  ...
  public readonly build = async (
    ...
    const streamerInhibKill = stats.find(
      (statEvent) =>
