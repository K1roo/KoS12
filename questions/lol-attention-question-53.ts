...
@Injectable()
export class LolAttentionQuestion53 extends LolAttentionQuestion {
  private _logger: WinstonLogger = new WinstonLogger(
    LolAttentionQuestion53.name,
  );
  public readonly id = 53;
  public readonly title =
    'When did {{streamerName}} get his first ability to 5 points?';
