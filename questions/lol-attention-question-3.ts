...
@Injectable()
export class LolAttentionQuestion3 extends LolAttentionQuestion {
  private _logger: WinstonLogger = new WinstonLogger(
    LolAttentionQuestion3.name,
  );
  public readonly id = 3;
  public readonly title = 'Did {{streamerName}} get kills in the last game?';
