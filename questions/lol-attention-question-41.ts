...
@Injectable()
export class LolAttentionQuestion41 extends LolAttentionQuestion {
  private _logger: WinstonLogger = new WinstonLogger(
    LolAttentionQuestion41.name,
  );
  public readonly id = 41;
  public readonly title =
    'Did {{streamerName}} get any multi-kills during the game?';
  ...
  public readonly build = async (
    ...
    const streamerMultiKillEvent = stats.find(
      (statEvent) =>
