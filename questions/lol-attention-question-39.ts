...
@Injectable()
export class LolAttentionQuestion39 extends LolAttentionQuestion {
  private _logger: WinstonLogger = new WinstonLogger(
    LolAttentionQuestion39.name,
  );
  public readonly id = 39;
  public readonly title =
    'Did {{streamerName}} get First Blood during the game?';
  ...
  public readonly build = async (
    ...
    if (firstBloodEvent.data.stats.val.Recipient !== streamerName) {
