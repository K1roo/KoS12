...
const boostId = 'SuperStar' as KosBoostId;

@Boost(boostId)
@Injectable()
export class SuperStarBoostService extends KosUserBoostService {
  private readonly _logger = new WinstonLogger(SuperStarBoostService.name);

  public lootWeight = 1;
  public rarity = 0;

  public readonly id = boostId;
  public readonly title = 'SuperStar';
  public readonly description = 'Multiply your Final Challenge Score by 50%';
  public readonly iconUrl =
    'https://assets.azarus.io/kos/boosts-icons/super-star.svg';
  ...
  public async apply(
    ...
    this._logger.debug('Applying SuperStar');
