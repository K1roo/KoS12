...
const boostId = 'SuperMegaStar' as KosBoostId;

@Boost(boostId)
@Injectable()
export class SuperMegaStarBoostService extends KosUserBoostService {
  private readonly _logger = new WinstonLogger(SuperMegaStarBoostService.name);

  public lootWeight = 1;
  public rarity = 3;

  public readonly id = boostId;
  public readonly title = 'SuperMegaStar';
  public readonly description = 'Multiply your Final Challenge Score by 150%';
  public readonly iconUrl =
    'https://assets.azarus.io/kos/boosts-icons/super-mega-star-29042021.svg';
  ...
  public async apply(
    ...
    this._logger.debug('Applying SuperMegaStar');
